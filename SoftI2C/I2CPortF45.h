...
#else
{
  __asm__ __volatile__ 
    (
     ...
     " call    ass_i2c_wait_scl_high_pf45   ;wait until SCL=H\n\t"
     // 不等待，scl为低直接返回
     // " clr      r24                     ;set return value to false \n\t"
     // " sbis     %[SCLIN],%[SCLPIN]      ;check for SCL high \n\t"
     // " ret                              ;if low return with false \n\t" 
     ...
     " call    ass_i2c_delay_half_pf45      ;wait T/2 \n\t"
     " call    ass_i2c_write_pf45           ;now write address \n\t"
     " ret"
     : : [SDADDR] "I"  (SDA_DDR_PF45), [SDAPIN] "I" (SDA_PIN_PF45),
...
#else
{
  __asm__ __volatile__ 
    ...
    (
     ...
     " call 	ass_i2c_delay_half_pf45	;delay  T/2 \n\t" 
     " cbi	%[SDADDR],%[SDAPIN]	;release SDA \n\t"
#if I2C_PULLUP
     " sbi      %[SDAOUT],%[SDAPIN]     ;enable SDA pull-up \n\t"
#endif
...
#endif     
     " sbi      %[SDADDR],%[SDAPIN]     ;force SDA low \n\t" 
     " call    ass_i2c_delay_half_pf45      ;T/2 delay \n\t"
     " cbi      %[SCLDDR],%[SCLPIN]     ;release SCL \n\t" 
#if I2C_PULLUP
     " sbi      %[SCLOUT],%[SCLPIN]	;enable SCL pull-up \n\t"
#endif
...
#else
{
  __asm__ __volatile__ 
    (
     ...
     " sbi      %[SDAOUT],%[SDAPIN]     ;enable SDA pull-up \n\t"
#endif
     " jmp      _Li2c_write_high_pf45                              ;; +2 = 11C \n\t"
...
#if I2C_DELAY_COUNTER >= 1
     " call 	ass_i2c_delay_half_pf45	;delay T/2             ;;+X = 11C+X\n\t"
#endif
     ...
     " call    ass_i2c_wait_scl_high_pf45 \n\t"
     " brpl     _Ldelay_scl_high_pf45                              ;;+2 = 18C+X\n\t"
     "_Li2c_write_return_false_pf45: \n\t"
     " clr      r24                     ; return false because of timeout \n\t"
     " jmp     _Li2c_write_return_pf45 \n\t"
     "_Ldelay_scl_high_pf45: \n\t"
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2             ;;+X= 18C+2X\n\t"
#endif
     " jmp	_Li2c_write_bit_pf45 \n\t"
...
#endif
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2 ;; +X = 7C+X \n\t"
#endif
     " clr	r25                                            ;; 17C+2X \n\t"
...
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2             ;; 16C + 2X \n\t"
#endif
...
#else
{
  __asm__ __volatile__ 
    (
     ...
     " nop \n\t"
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2             ;; 4C+X \n\t" 
#endif
...
#endif
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2             ;; 6C + 2X \n\t" 
#endif
     ...
     " nop \n\t "
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2             ;; 7C + X \n\t" 
#endif
     ...
     " call    ass_i2c_wait_scl_high_pf45 \n\t"
#if I2C_DELAY_COUNTER >= 1
     " call	ass_i2c_delay_half_pf45	;delay T/2             ;; 11C + 2X\n\t" 
#endif
